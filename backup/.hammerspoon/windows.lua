...
enable_window_snapping_with_mouse = false
...
-------------------------------------------------------------------
--Window moving between spaces
-------------------------------------------------------------------

--These are not working and I have no idea why
...
hs.hotkey.bind({"alt", "ctrl"}, "Down", function()
	hs.alert.show(hs.application.frontmostApplication():title() .. " Top Center", show_window_notification_duration)
	local win = hs.window.focusedWindow()
	local f = win:frame()
	local screen = win:screen()
	local max = screen:frame()
